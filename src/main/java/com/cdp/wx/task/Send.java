...
public class Send {
     ...
     */
    public void send1(String token, Weather w, String text, String userid) throws ParseException {
...
//        sendData.setAir_tips(new Item(w.getAir_tips(), "#0acffe"));
        sendData.setAir_tips(new Item(text, "#0acffe"));
        sendData.setPressure(new Item(w.getPressure() + "hPa", "#0acffe"));
        ...
        //附加数据
        sendData.setTxt1(new Item("亲爱的乖乖宝贝，早上好！记得按时吃早饭午饭晚饭，今天也要开心哟！", "#ff7eb3"));
        sendData.setTxt2(new Item("下面由我来给你播报一下今天的天气状况吧！", "#f09819"));
//        sendData.setTxt3(new Item(text,"#f09819"));
        //发送请求
     ...
     * @param token
     */
    public void send2(String token, String text, String userid) throws ParseException {
        String url = "https://api.weixin.qq.com/cgi-bin/message/template/send?access_token=" + token;
        String c1 = "#fdcbf1";
        SendJson sendJson = new SendJson();
        sendJson.setTouser(userid);
        ...
        sd.setTxt2(new Item(text, "#cd9cf2"));
//        sd.setTxt3(new Item(text, "#f09819"));
        sendJson.setData(sd);
        String s = restTemplate.postForObject(url, sendJson, String.class);
        System.out.println(s);
    }
